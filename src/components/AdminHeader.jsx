...
import { SidebarTrigger, Separator, Breadcrumb, BreadcrumbItem, BreadcrumbLink, BreadcrumbList, BreadcrumbPage, BreadcrumbSeparator } from '@fob/lib-ui';

/**
 * Admin header with breadcrumbs - matches AppBreadcrumbs styling
 * @param {Object} props
 * @param {Array<{href?: string, text: string}>} [props.breadcrumbs] - Breadcrumb items
